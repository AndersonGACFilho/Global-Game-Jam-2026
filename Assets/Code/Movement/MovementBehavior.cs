...
public class MovementBehavior : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        entityRigidbody.collisionDetectionMode = CollisionDetectionMode2D.Continuous;

        if (entityBehavior.entityWorldCollider != null)
        {
            entityBehavior.entityWorldCollider.isTrigger = false;
        }
    }
